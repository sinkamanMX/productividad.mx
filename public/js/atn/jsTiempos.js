...
function getReportAll(){
  ...
  var url = "/atn/reptiempos/exportall?optReg="+strOpt+"&cboInstalacion="+idSucursal+"&inputTecnicos="+idTecnico+"&inputFechaIn="+inputFecIn+"&inputFechaFin="+inputFecFin+"&inputStatus="+iStatus+"&cboTypeSearch="+bType;
