<?php
	...
	$sMails   = "c.instalaciones@grupouda.com.mx,oper.mesadecontrol@grupouda.com.mx,servicioaclientes@grupouda.com.mx,sup.monitoreo@grupouda.com.mx,contralor’a@grupouda.com.mx,c.cxc@grupouda.com.mx,a.cxc@grupouda.com.mx,c.almacen@grupouda.com.mx,calidad@grupouda.com.mx,c.instalaciones@grupouda.com.mx,oper.mesadecontrol@grupouda.com.mx,servicioaclientes@grupouda.com.mx,sup.monitoreo@grupouda.com.mx,contraloría@grupouda.com.mx,c.cxc@grupouda.com.mx,a.cxc@grupouda.com.mx,c.almacen@grupouda.com.mx,calidad@grupouda.com.mx,avl.csanchez@grupouda.com.mx" ;
	...
	while($result = mysqli_fetch_array($query)){
		...
		$sMensaje = 'Detalle de su solicitud de servicio - Folio '.@$aInfo['FOLIO'];
	...
	function getDataInfo($idCita){
		...
		$aResult = Array();
	  	$sql = "SELECT C.ID_CITA, C.FECHA_CITA, C.HORA_CITA, C.CONTACTO, C.TELEFONO_CONTACTO,
				...
				L.RAZON_SOCIAL, T.DESCRIPCION AS N_TIPO, L.EMAIL,C.FOLIO
			FROM PROD_CITAS C 
